...
def main():
    ...
    adjusted_lists = adjust_one_sided_lists(lists)
    adj=pandas.DataFrame(data= {"gene_symbol": data.iloc[1:,0],"up":adj_lists[0],"down":adj_lists[1]}).reindex_axis(["gene_symbol","up","down"],axis=1)
    return adj
